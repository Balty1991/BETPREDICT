...
function App() {
  ...
  return (
    <div className={`min-h-screen ${dark ? 'bg-[#05080f]' : 'bg-slate-100'}`}>
      {/* Ambient gradients */}
      ...
      <header className="fixed top-0 inset-x-0 z-30 h-14 bg-[#05080f]/90 backdrop-blur-xl border-b border-white/[0.06]">
        <div className="max-w-lg mx-auto h-full flex items-center justify-between px-4">
          ...
          <div className="flex items-center gap-1">
            ...
            <button onClick={() => setDark(d => !d)} className="p-2 rounded-lg text-[#6b7a9e] hover:text-white transition-colors">
          ...
          {tabs.map(t => (
            ...
            >
              <div className="relative">
                <div className={`transition-transform ${page === t.id ? 'scale-110' : ''}`}
